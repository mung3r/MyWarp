CREATE TEMPORARY TABLE "warp_backup"("warp_id","name","player_id","x","y","z","pitch","yaw","world_id","creation_date","type","visits","welcome_message");
INSERT INTO "warp_backup" SELECT * FROM "warp";
DROP TABLE "warp";
CREATE TABLE "warp"(
...
INSERT INTO "warp" SELECT * FROM "warp_backup";
DROP TABLE "warp_backup";

CREATE TEMPORARY TABLE "warp_player_map_backup"("warp_id","player_id");
INSERT INTO "warp_player_map_backup" SELECT * FROM "warp_player_map";
...
INSERT INTO "warp_player_map" SELECT * FROM "warp_player_map_backup";
DROP TABLE "warp_player_map_backup";

CREATE TEMPORARY TABLE "warp_group_map_backup"("warp_id","group_id");
INSERT INTO "warp_group_map_backup" SELECT * FROM "warp_group_map";
...
INSERT INTO "warp_group_map" SELECT * FROM "warp_group_map_backup";
