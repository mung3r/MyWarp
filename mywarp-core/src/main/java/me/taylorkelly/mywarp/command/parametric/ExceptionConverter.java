...
import me.taylorkelly.mywarp.command.parametric.binding.WarpBinding.NoSuchWarpException;
...
public class ExceptionConverter extends ExceptionConverterHelper {
  ...
  public void convert(NoSuchPlayerException ex) throws CommandException {
    throw new CommandException(msg.getString("exception.no-such-player", ex.getQuery()), ex);
  }
  ...
  public void convert(NoSuchProfileException ex) throws CommandException {
    throw new CommandException(msg.getString("exception.no-such-profile", ex.getQuery()), ex);
  }
  ...
  public void convert(NoSuchWarpException ex) throws CommandException {
    ...
    builder.append(msg.getString("exception.no-such-warp", ex.getQuery()));

    if (match.isPresent()) {
      builder.appendNewLine();
      //builder.append(ChatColor.GRAY); //TODO use Builder
  ...
  public void convert(ExceedsInitiatorLimitException ex) throws CommandException {
    ...
    switch (ex.getExceededLimit()) {
      case TOTAL:
        builder.append(msg.getString("exception.exceeds-initiator-limit.total", ex.getLimitMaximum()));
        break;
      case PRIVATE:
        builder.append(msg.getString("exception.exceeds-initiator-limit.private", ex.getLimitMaximum()));
        break;
      case PUBLIC:
        builder.append(msg.getString("exception.exceeds-initiator-limit.public", ex.getLimitMaximum()));
        break;
    }
    builder.appendNewLine();
  ...
  public void convert(ExceedsLimitException ex) throws CommandException {
    ...
    throw new CommandException(
        msg.getString("exception.exceeds-limit", subject.getName().or(subject.getUniqueId().toString())), ex);
  }
  ...
  public void convert(TimerRunningException ex) throws CommandException {
    throw new CommandException(msg.getString("exception.timer-running", ex.getDurationLeft().get(TimeUnit.SECONDS)),
                               ex);
  }
  ...
  public void convert(IllegalCommandSenderException ex) throws CommandException {
    throw new CommandException(msg.getString("exception.illegal-command-sender"), ex);
  }
  ...
  public void convert(NoSuchWorldException ex) throws CommandException {
    throw new CommandException(msg.getString("exception.no-such-world", ex.getWorldRepresentation()), ex);
  }
  ...
  public void convert(FileNotFoundException ex) throws CommandException {
    throw new CommandException(msg.getString("exception.file-not-found", ex.getMessage()), ex);
  }
}
