...
public class Group extends org.jooq.impl.TableImpl<me.taylorkelly.mywarp.dataconnections.generated.tables.records.GroupRecord> {
	 ...
	 */
	public final org.jooq.TableField<me.taylorkelly.mywarp.dataconnections.generated.tables.records.GroupRecord, org.jooq.types.UInteger> GROUP_ID = createField("group_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");

	/**
	 * The column <code>mywarp.group.name</code>.
	 */
	public final org.jooq.TableField<me.taylorkelly.mywarp.dataconnections.generated.tables.records.GroupRecord, java.lang.String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(32).nullable(false), this, "");
	...
	public java.util.List<org.jooq.UniqueKey<me.taylorkelly.mywarp.dataconnections.generated.tables.records.GroupRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<me.taylorkelly.mywarp.dataconnections.generated.tables.records.GroupRecord>>asList(me.taylorkelly.mywarp.dataconnections.generated.Keys.KEY_GROUP_PRIMARY, me.taylorkelly.mywarp.dataconnections.generated.Keys.KEY_GROUP_GROUP_NAME_UQ);
	}
