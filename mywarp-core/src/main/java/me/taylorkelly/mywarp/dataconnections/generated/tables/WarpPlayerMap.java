...
public class WarpPlayerMap extends org.jooq.impl.TableImpl<me.taylorkelly.mywarp.dataconnections.generated.tables.records.WarpPlayerMapRecord> {
	 ...
	 */
	public final org.jooq.TableField<me.taylorkelly.mywarp.dataconnections.generated.tables.records.WarpPlayerMapRecord, org.jooq.types.UInteger> WARP_ID = createField("warp_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");

	/**
	 * The column <code>mywarp.warp_player_map.player_id</code>.
	 */
	public final org.jooq.TableField<me.taylorkelly.mywarp.dataconnections.generated.tables.records.WarpPlayerMapRecord, org.jooq.types.UInteger> PLAYER_ID = createField("player_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");
	...
	private WarpPlayerMap(java.lang.String alias, org.jooq.Table<me.taylorkelly.mywarp.dataconnections.generated.tables.records.WarpPlayerMapRecord> aliased) {
		this(alias, aliased, null);
	}

	private WarpPlayerMap(java.lang.String alias, org.jooq.Table<me.taylorkelly.mywarp.dataconnections.generated.tables.records.WarpPlayerMapRecord> aliased, org.jooq.Field<?>[] parameters) {
	...
	public java.util.List<org.jooq.UniqueKey<me.taylorkelly.mywarp.dataconnections.generated.tables.records.WarpPlayerMapRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<me.taylorkelly.mywarp.dataconnections.generated.tables.records.WarpPlayerMapRecord>>asList(me.taylorkelly.mywarp.dataconnections.generated.Keys.KEY_WARP_PLAYER_MAP_PRIMARY);
	}
	...
	public java.util.List<org.jooq.ForeignKey<me.taylorkelly.mywarp.dataconnections.generated.tables.records.WarpPlayerMapRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<me.taylorkelly.mywarp.dataconnections.generated.tables.records.WarpPlayerMapRecord, ?>>asList(me.taylorkelly.mywarp.dataconnections.generated.Keys.WARP_PLAYER_MAP_WARP_ID_FK, me.taylorkelly.mywarp.dataconnections.generated.Keys.WARP_PLAYER_MAP_PLAYER_ID_FK);
	}
