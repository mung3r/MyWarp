...
public class JOOQConnection implements DataConnection {
     ...
     * @param executor
     *            the executor that runs all tasks
     */
    ...
    /**
     * Gets the GroupRecord representing the given group identifier or creates
     * it, if it does not yet exit.
     * 
     * @param groupName
    ...
    /**
     * Gets the PlayerRecord representing the given Profile or creates it, if it
     * does not yet exit.
     * 
     * @param profile
     *            the Profile
    ...
    /**
     * Gets the WorldRecord representing the world of the given name or creates
     * it, if it does not yet exit.
     * 
            ...
            public Collection<Warp> call() {
                ...
                for (Result<Record14<String, Profile, Type, Double, Double, Double, Float, Float, UUID, Date, UInteger, String, Profile, String>> r : groupedResults
                    ...
                    WarpBuilder builder = new WarpBuilder(r.getValue(0, WARP.NAME), creator, r.getValue(0,
                            WARP.TYPE), r.getValue(0, WORLD.UUID), position, rotation);
