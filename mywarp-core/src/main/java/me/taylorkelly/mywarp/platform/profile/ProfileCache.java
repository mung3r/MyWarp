...
package me.taylorkelly.mywarp.platform.profile;
...
public interface ProfileCache {
  ...
  /**
   * Gets an Optional containing the Profile of the given name, if such a Profile exists.
   *
   * <p>Since Minecraft usernames are case-insensitive, {@link Profile#getName()} may return a name with a different
   * case than the requested one. The returned one is than guaranteed to have the correct case. </p>
   *
