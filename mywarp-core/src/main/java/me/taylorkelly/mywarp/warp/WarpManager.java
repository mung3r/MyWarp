...
/**
 * Manages Warps and provides utility methods to get certain informations based
 * on the Warps managed by it.
 */
public interface WarpManager {
    ...
    /**
     * Gets an Optional containing the Warp of the given name managed by this
     * manager, if such a Warp exists.
     * 
     * @param name
     *            the exact name
    ...
    /**
     * Gets all Warps on this manager that fulfill the given Predicate. The
     * returned collection is a live view, changes to one affect the other. If a
     * live view is not needed, it may be faster to create a copy of the Warps
    ...
    /**
     * Gets an Optional containing a warp's creator whose name uniquely matches
     * the given filter within the Warps fulfilling the given Predicate ,if such
     * a creator exists.
     * 
     * @param filter
     *            the filter
    ...
    /**
     * Gets an Optional containing a warp's world whose name uniquely matches
     * the given filter within the Warps fulfilling the given Predicate, if such
     * a world exists.
     * 
     * @param filter
