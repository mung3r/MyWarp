...
public class WarpBuilder {
     ...
     * @param creator
     *            the Profile of the player who created the warp
     * @param type
     *            the type
     * @param world
     ...
     *            the name of the world where the warp is placed
     * @param position
     *            the position of the warp
     * @param rotation
     *            the rotation of the warp
    ...
    /**
     * Adds the given player-profile to the set of invited players for this
     * warp.
     * 
     * @param player
