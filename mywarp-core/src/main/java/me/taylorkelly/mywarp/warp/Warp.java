...
/**
 * Represents a Warp. Implementations must ensure that two Warps are equal if, and only if their
 * names are equal. <p> To create new warps use a {@link WarpBuilder}. </p>
 */
public interface Warp extends Comparable<Warp> {
  ...
  /**
   * A custom comparator that orders Warps by there popularity: popular Warps come first, unpopular
   * last.
   */
  ...
  /**
   * Teleports the given player to this Warp, sends the applicable message and withdraws the
   * applicable fee.
   *
   * @param player the player
  ...
  /**
   * Invites the permission-group identified by the given ID to this Warp. This method will also
  ...
  /**
   * Invites the player identified by the given Profile to this Warp. This method will also attempt
   * to update this Warp via the active data-connection.
   *
  ...
  /**
   * Uninvites the permission-group identified by the given ID from this Warp. This method will also
   * attempt to update this Warp via the active data-connection.
   *
  ...
  /**
   * Uninvites the player identified by the given Profile from this Warp. This method will also
   * attempt to update this Warp via the active data-connection.
   *
  ...
  /**
   * Replaces all placeholder in the given string with the values applicable for this Warp and the
   * given player.
   *
   * @param str     the string that contains the placeholder
   * @param forWhom the player for whom the placeholder should be replaced - can be null if there is
   *                none
  ...
  /**
   * Gets this Warp's welcome message. Use {@link #getParsedWelcomeMessage(LocalPlayer)} to get the
   * welcome message without any variables.
   *
  ...
  /**
   * Gets this Warp's welcome message with replaced variables. Use {@link #getWelcomeMessage()} to
   * get the raw welcome message.
   *
  ...
  /**
   * Sets the location of this Warp. A location consists of three parts: <ol> <li>the world where
   * the location is</li> <li>the position in the world</li> <li>the rotation of the position</li>
   * </ol>
   *
  ...
  /**
   * Gets this Warp's popularity score. The score is influenced by the number of visits a Warp
   * received since it was created, while newer Warps receive a better score than older Warps.
   *
