...
public class DynamicMessages {
    ...
    /**
     * Creates an instance. Strings will be looked up from a ResourceBundle of
     * the given name.
     * 
     * @param baseName
     ...
     * <p>
     * If no translation exits, {@code $ key} will be returned.
     * </p>
     * 
     * @param key
     *            the key
     ...
     * <p>
     * If no translation exits, {@code $ key}:args} will be returned.
     * </p>
     * 
     * @param key
     *            the key
