 ...
 * <p/>
 * Strategies are evaluated in the order they were registered, using the returned value of one strategy for the second
 * etc.. If one strategy returns an empty Optional indicating that no valid position exists, this Strategy will return
 * an empty Optional.
 */
