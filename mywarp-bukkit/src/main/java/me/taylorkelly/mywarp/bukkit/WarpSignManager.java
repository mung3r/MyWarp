...
public class WarpSignManager extends AbstractListener {
    ...
    private static final ImmutableSet<Material> SUPPORTED_PLATES = ImmutableSet.of(Material.WOOD_PLATE,
    ...
    /**
     * Initializes this manager using the given identifiers, operation on the
     * given WarpManager.
     *
     * @param identifiers
     *            the identifiers
