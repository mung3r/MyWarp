...
public class PlayerBinding extends BindingHelper {
     ...
     *             if the binding has the {@link Sender} annotation, but the
    ...
    public LocalPlayer getString(ArgumentStack context, Annotation[] modifiers) throws NoSuchPlayerException,
    ...
    /**
     * Gets the player who used the command with the given CommandLocals.
     * <p>
     * It is expected that the sender of the command is an {@link Actor} and
     * stored in the given CommandLocals under the actor class.
     * </p>
     * 
     * @param locals
     *            the CommandLocals
     * @return the player
     * @throws ParameterException
     *             if CommandLocals does not contain a mapping for the
     *             {@link Actor} class
     * @throws IllegalCommandSenderException
     *             if the mapping for the {@link Actor} class is not a player
     */
    ...
    /**
     * Indicates that the LocalPlayer binding should be parsed from the Actor
     * who used the command instead of resolving it from a command argument.
     */
    ...
    /**
     * Thrown when the player should be parsed from the Actor who called the
     * command, but his Actor is not a player instance.
     */
    ...
    /**
     * Thrown when none of the players who are online has a name that matches a
     * given query.
     */
