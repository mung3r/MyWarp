...
public class StringPaginator<E> {
    ...
    public class PaginatedResults {
         ...
         *             if there are no results that could be paginated
         * @throws UnknownPageException
         *             if there are results that could be paginated, but no page
         *             with the given number exists
         */
        ...
        /**
         * Displays the given page to the given Actor. This method will catch
         * checked exceptions and send the appropriate error message instead.
         * 
         * @param actor
         *            the Actor
         * @param page
