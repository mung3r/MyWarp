...
/**
 * Provides Durations when running on Bukkit. The actual Durations are stored in
 * {@link DurationBundle}s managed by this provider.
 * <p>
 * Players either need to have a specific permission of a certain bundle or they
 * fall under a default bundle. If a player has the permission for more than one
 * bundle, the alphabetically first bundle will be used.
 * </p>
 */
public class BukkitDurationProvider implements DurationProvider {
     ...
     * 
     * @param configuredDurations
     *            the configured FeeBundles that are assigned to a player via a
     *            specific permission
     * @param defaultDurations
     *            the default FeeBundle that acts as a fallback if a player has
     *            none of the specific permissions
     */
    ...
    public static class DurationBundle extends ValueBundle {
         ...
         * @param warpCooldown
         *            the cooldown for the {@code warp} command
         * @param warpWarmup
         *            the warmup for the {@code warp} command
         */
