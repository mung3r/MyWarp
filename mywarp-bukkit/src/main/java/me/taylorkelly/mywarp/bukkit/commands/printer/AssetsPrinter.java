...
/**
 * Prints a certain player's assets, showing active limits and Warps sorted to
...
public class AssetsPrinter {
     ...
     * 
     * @param creator
     *            the player whose assets should be displayed
     * @param limitManager
     *            the limitManager that manages the limits that should be
     *            displayed
     */
     ...
     * 
     * @param receiver
     *            the Actor who is receiving this print
     */
    ...
    /**
     * Prints the given Limit to the receiver. The given Warps will be matched
     * to the individual Limit.Types and displayed accordingly.
     * 
     * @param receiver
     *            the Actor who is receiving this print
     * @param limit
     *            the limit
     * @param warps
     *            the Warps that are affected by the given Limit
     */
    private void printLimit(Actor receiver, Limit limit, Collection<Warp> warps) {
        ...
        for (Limit.Type type : DISPLAYABLE_TYPES) {
            ...
            limitStrings.add(ChatColor.GOLD + MESSAGES.getString("assets." + type.lowerCaseName(), // NON-NLS
                    warpLimitCount(privateWarps.size(), limit.getLimit(type))) + ' ' + ChatColor.WHITE
    ...
    /**
     * Creates a String with the count-suffix from the given warp-count and the
     * given limit-maximum.
     * 
     * @param warpCount
     *            the warp-count
