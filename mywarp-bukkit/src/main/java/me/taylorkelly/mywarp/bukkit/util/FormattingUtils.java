 ...
 * players. Colors are supported, bold and italic formatting not!
 * <p>
 * The basic character widths this class relies on where extracted from old
 * Minecraft source code. The algorithm and supported characters in Minecraft
 * have changed, but these changes are not covered!
 * </p>
 */
public final class FormattingUtils {
    ...
    /**
     * Calls {@link #padddingRight(String, char)} using a space as padding
     * character.
     * 
     * @param str
     *            the string
    ...
    /**
     * Calls {@link #padddingRight(String, char, int)} using the chat width as
     * paddedWidth.
     * 
     * @param str
     *            the string
    ...
    /**
     * Calls {@link #padddingLeft(String, char, int)} using the chat width as
     * paddedWidth.
     * 
     * @param str
     *            the string
    ...
    /**
     * Calls {@link #wrap(String, String, int)} using the chat width as
     * totalWidth.
     * 
     * @param str
     *            the string to wrap
     * @param newLinePrefix
     *            the prefix for created new lines
     * @return the wrapped string
     */
    ...
    /**
     * Wraps the given String into multiple lines so that each line is at most
     * as wide as the given width. Each new line will start with the given
     * prefix.
     * 
     * @param str
     *            the string to wrap
    ...
    /**
     * Joins the given parts, separated by blanks. The resulting string will be
     * wrapped into multiple lines so that each line is at most as wide as the
     * given width. Each new line will start with the given prefix.
     * 
     * @param parts
     *            the parts
     * @param newLinePrefix
    ...
    /**
     * Calls {@link #toList(char, int, List)} using the chat width as
     * totalWidth.
     * 
     * @param listChar
