 ...
 * Once created the matching is 'static' as matching warps are internally stored
 * in the instance. If changes need to be reflected, a new instance needs to be
 * created.
 */
public class MatchList {
    ...
    /**
     * Initializes a MatchList using the given filter to filter warp-names,
     * operating upon the given warps.
     * 
     * @param filter
     *            the filter
     * @param matchingWarps
     *            an Iterable of matching warps this MatchList should operate on
     */
    ...
    /**
     * Gets an Optional that contains an exact match (if such a Warp exists). A
     * Warp is an exact match if it fulfills one of the following conditions,
     * starting from the top:
     * <ol>
     * <li>the only Warp whose name contains case-insensitively this MatchList's
     * filer,</li>
     * <li>the only Warp whose name is case insensitively equal to this
     * MatchList's filter,
     * <li>the only Warp whose name is equal to this MatchList's filter.</li>
     * </ol>
     * 
    ...
    /**
     * Gets an Optional that contains the Warp that matches this Matchers
     * criteria and is the first when sorting all matching warps naturally (if
     * such a Warp exists).
     * 
    ...
    /**
     * Gets an Optional that contains the Warp that matches this Matchers
     * criteria and is the first when sorting all matching warps with the given
     * Comparator (if such a Warp exists).
     * 
     * @param comparator
