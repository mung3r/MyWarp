...
public class World extends
        org.jooq.impl.TableImpl<me.taylorkelly.mywarp.dataconnections.jooq.tables.records.WorldRecord> {
     ...
     */
    public final org.jooq.TableField<me.taylorkelly.mywarp.dataconnections.jooq.tables.records.WorldRecord, org.jooq.types.UInteger> WORLD_ID = createField(
            "world-id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>mywarp.world.world</code>.
     */
    public final org.jooq.TableField<me.taylorkelly.mywarp.dataconnections.jooq.tables.records.WorldRecord, java.util.UUID> WORLD_ = createField(
            "world",
    ...
    private World(java.lang.String alias,
            org.jooq.Table<me.taylorkelly.mywarp.dataconnections.jooq.tables.records.WorldRecord> aliased) {
    ...
    public java.util.List<org.jooq.UniqueKey<me.taylorkelly.mywarp.dataconnections.jooq.tables.records.WorldRecord>> getKeys() {
        return java.util.Arrays
                .<org.jooq.UniqueKey<me.taylorkelly.mywarp.dataconnections.jooq.tables.records.WorldRecord>> asList(
                        me.taylorkelly.mywarp.dataconnections.jooq.Keys.KEY_WORLD_PRIMARY,
                        me.taylorkelly.mywarp.dataconnections.jooq.Keys.KEY_WORLD_U_WORLD);
    }
