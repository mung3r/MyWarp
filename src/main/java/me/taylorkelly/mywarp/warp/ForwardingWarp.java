...
/**
 * A Warp which forwards all its method calls to another Warp. Subclasses should
 * override one or more methods to modify the behavior of the backing Warp as
 * desired per the <a
