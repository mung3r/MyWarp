...
public class SimpleWarp implements Warp {
     ...
     *             if any of the Builder's fields is {@code null}
     * @throws IllegalArgumentException
     *             if the Builder's {@code invitedPlayerIds} or
     *             {@code invitedGroups} contains {@code null}
     */
    SimpleWarp(WarpBuilder builder) throws NullPointerException, IllegalArgumentException {
