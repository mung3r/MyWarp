...
/**
 * Represents a Warp. Implementations must ensure that two Warps are equal if,
 * and only if their names are equal.
 * <p>
 * To create new warps use a {@link WarpBuilder}.
 * </p>
 */
public interface Warp extends Comparable<Warp> {
    ...
    enum Type {
        ...
        /**
         * This types colorCharacter-representation used when displaying
         * Warp-names of this type.
         */
    ...
    /**
     * Returns whether the given profile is equal to the profile of the player
     * who created this Warp.
     * 
     * @param profile
     *            the profile
    ...
    /**
     * Returns whether the given Profile identifies a player who is invited to
     * this Warp.
     * 
     * @param profile
     *            the Profile
    ...
    /**
     * Invites the player identified by the given Profile to this Warp. This
     * method will also attempt to update this Warp via the active
     * data-connection.
     * 
     * @param player
     *            the profile of the player who should be invited
     */
    ...
    /**
     * Uninvites the player identified by the given Profile from this Warp. This
     * method will also attempt to update this Warp via the active
     * data-connection.
     * 
     * @param player
     *            the Profile of the player who should be uninvited
     */
    ...
    /**
     * Gets an unmodifiable set containing the Profiles of all players invited
     * to this Warp.
     * 
     ...
     * {@link #getParsedWelcomeMessage(LocalPlayer)} to get the welcome message
     ...
     * 
     * @param creator
     *            the profile of the new creator
     */
    ...
    /**
     * Sets the location of this Warp. A location consists of three parts:
     * <ol>
     * <li>the world where the location is</li>
     * <li>the position in the world</li>
     * <li>the rotation of the position</li>
     * </ol>
     * 
     * @param world
     *            the world
