...
public class DynmapMarkers {
     ...
     * @param manager
     *            the EventWarpManager this Markers run on
     */
    ...
    private void addMarker(Warp warp) {
        ...
        markerSet.createMarker(toMarkerId(warp), toLabelHtml(warp), true, warp.getWorld().getName(), warp
                .getPosition().getX(), warp.getPosition().getY(), warp.getPosition().getZ(), markerIcon,
                false);
    }
