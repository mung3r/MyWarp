...
public class BukkitPlayer extends AbstractPlayer {
    ...
    /**
     * Attempts to get the locale used by the given player (client-side).
     * <p>
     * This method relies on reflection to load the minecraft-player-object
     * through the craftbukkit-implementation and access its {@code locale}
     * field. It may break on Minecraft or CraftBukkit updates.
     * </p>
     * 
     * @param p
     *            the player
    ...
    /**
     * Teleports the given {@link org.bukkit.entity.Entity} to the given
     * {@link org.bukkit.Location}.
     * 
     * @param teleportee
     *            the Entity to teleport
     * @param bukkitLoc
     *            the Location where the Entity is teleported
     * @param teleportTamedHorses
     *            whether ridden, tamed horses should be teleported too
     * @param teleportLeashed
     *            whether Entities leashed by the teleported Entity should be
     *            teleported too
     */
