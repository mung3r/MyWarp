...
public class WarpBinding extends BindingHelper {
    ...
    /**
     * Gets a Warp matching the query and the Condition modifier given by the
     * command.
     * 
     * @param context
     ...
     *             if no Warp matching the query and Condition exists
     ...
     *             if no Condition could be found
     */
    private Condition findCondition(Annotation[] annotations) throws NoSuchElementException {
    ...
    public @interface Condition {
        ...
        enum Type {
             ...
             * 
             * @param clazz
             *            the class of the instance that corresponds with this
             *            Condition.
             */
    ...
    public class NoSuchWarpException extends Exception {
         ...
         *            the query
         * @param matches
         *            the possible matches of the query
         */
