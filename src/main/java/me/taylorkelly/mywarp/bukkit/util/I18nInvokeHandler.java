...
public class I18nInvokeHandler implements InvokeListener, InvokeHandler {
    ...
    public void updateDescription(Object object, Method method, ParameterData[] parameters,
        ...
        String describtionKey = description.getShortDescription();
        if (describtionKey != null && !describtionKey.isEmpty()) {
            description.setDescription(MESSAGES.getString(describtionKey));
        }
